...
# cardio_disease_project documentation build
...
from cardio_disease_project import __version__ as release

# -- Project information -----------------------------------------------------

project = "cardio_disease_project"
author = "Kedro"
...
htmlhelp_basename = "cardio_disease_projectdoc"
...
latex_documents = [
    (
        master_doc,
        "cardio_disease_project.tex",
        "cardio_disease_project Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "cardio_disease_project",
        "Project cardio_disease_project codebase.",
        "Data-Science",
    )
]
